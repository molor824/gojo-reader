...
const Monopo = () => {
  ...
  const [_mousePosition, setMousePosition] = useState({ x: 0.5, y: 0.5 });
                  ...
                  return (
                    ...
                    >
                      <span
                        ...
                        style={{
                          transform: hoveredWords.has(globalIndex)
                            ? "translateY(0.05em)"
                            : "translateY(0)",
                        }}
                      >
